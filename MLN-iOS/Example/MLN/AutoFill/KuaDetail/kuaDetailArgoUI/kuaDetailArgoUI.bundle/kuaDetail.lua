...
if lrqUserData== nil then 
lrqUserData= BindMeta("lrqUserData")
end
...
local vwj4 = Label()
ui_views.vwj4 = vwj4
vwj4:text(lrqUserData.title.__get)
lrqUserData.title.__watch=function(new)
vwj4:text(new)
end
...
DataBinding:bindListView(lrqUserData.listSource.__path,vwj5)
vwj5_adapter:sectionCount(function()
return DataBinding:getSectionCount(lrqUserData.listSource.__path)
end)
vwj5_adapter:rowCount(function(section1)
return  DataBinding:getRowCount(lrqUserData.listSource.__path,section1)
end)
vwj5_adapter:fillCellDataByReuseId("commentCell", function(_l_c1,section1,row1)
local _l_i1=lrqUserData.listSource[section1][row1].__ci
local kvar8=_l_i1
...
local kvar9=1
local kvar10=kvar8
_l_c1.vwj45:text((#kvar10.reply.__get >= kvar9 and{kvar10.reply[kvar9].name.__get} or{""})[1])
_l_c1.vwj47:text((#kvar10.reply.__get >= kvar9 and{kvar10.reply[kvar9].content.__get} or{""})[1])
_l_c1.vwj44:display((#kvar10.reply.__get >= kvar9))
local kvar11=2
local kvar12=kvar8
_l_c1.vwj49:text((#kvar12.reply.__get >= kvar11 and{kvar12.reply[kvar11].name.__get} or{""})[1])
_l_c1.vwj51:text((#kvar12.reply.__get >= kvar11 and{kvar12.reply[kvar11].content.__get} or{""})[1])
_l_c1.vwj48:display((#kvar12.reply.__get >= kvar11))
_l_c1.vwj52:display((#kvar8.reply.__get >= 3))
BindMetaWatchListCell(lrqUserData.listSource,section1,row1)
end)
...
local kvar16 = function()
local kvar15 = {}
local add = function(_v_)
if type(_v_) == "table" then
for _, _v in ipairs(_v_) do
table.insert(kvar15, _v)
end
elseif _v_ then
table.insert(kvar15, _v_)
end
end
add(kvar13())
_l_c1.vwj16:children(kvar15)
end
