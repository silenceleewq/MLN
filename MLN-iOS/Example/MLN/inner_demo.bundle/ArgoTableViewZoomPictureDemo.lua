...
local function initAdapter()
    ...
    adapter:fillCellDataByReuseId("cell", function(cell, section, row)
        ...
        cell.iv:scaleBegin(function(focusX, focusY, span, spanX, spanY, factor)
            print("scaleBegin: focusX = ", focusX, " focusY = ", focusY, " span = ", span, " spanX = ", spanX, " spanY = ", spanY, " factor = ", factor)
        end)
        cell.iv:scaling(function(focusX, focusY, span, spanX, spanY, factor)
            print("scaling: focusX = ", focusX, " focusY = ", focusY, " span = ", span, " spanX = ", spanX, " spanY = ", spanY, " factor = ", factor)
        end)
        cell.iv:scaleEnd(function(focusX, focusY, span, spanX, spanY, factor)
            print("scaleEnd: focusX = ", focusX, " focusY = ", focusY, " span = ", span, " spanX = ", spanX, " spanY = ", spanY, " factor = ", factor)
        end)
        --cell.iv:enabled(true)
        --cell.iv:touchBeginExtension(function(x)
        --    print("cell.iv::touchMoveExtension: x = ", x:get("pageX"), " y = ", x:get("pageY"))
        --end)
        --cell.iv:touchMoveExtension(function(x)
        --    print("cell.iv:touchMoveExtension: x = ", x:get("pageX"), " y = ", x:get("pageY"))
        --end)
        --cell.iv:touchEndExtension(function(x)
        --    print("cell.iv::touchMoveExtension: x = ", x:get("pageX"), " y = ", x:get("pageY"))
        --end)
        --cell.iv:touchCancelExtension(function(x)
        --    print("cell.iv::touchMoveExtension: x = ", x:get("pageX"), " y = ", x:get("pageY"))
        --end)
        
        cell.iv:enabled(true)
        cell.iv:touchBegin(function(x, y)
            print("cell.iv:touchBegin = ", x, y)
        end)
        cell.iv:touchMove(function(x, y)
            print("cell.iv:touchMove = ", x, y)
        end)
        cell.iv:touchEnd(function(x, y)
            print("cell.iv:touchEnd = ", x, y)
        end)
        cell.iv:touchCancel(function(x, y)
            print("cell.iv:touchCancel = ", x, y)
        end)
    end)
